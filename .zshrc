...
#补全 ssh scp sftp 等
my_accounts=(
{aax,root}@{192.168.128.1,192.168.0.1}
aax@192.168.128.2
)
...
##{{{ man 增加颜色 (通过LESS程序的变量？)
#export GROFF_ON_SGR=1   #应用于某些使用ANSI color escapes的term上
